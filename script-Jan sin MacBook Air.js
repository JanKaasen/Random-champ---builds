import runes from "./JSONfiles/Runes.json" with {type: "json"};
import items from "./JSONfiles/Items.json" with {type:"json"};
import champions from "./JSONfiles/champion_summary.json" with {type:"json"};
import roles from "./JSONfiles/roles.json" with {type:"json"};
import summonerSpells from "./JSONfiles/summoner_spells.json" with {type: "json"};
